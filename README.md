# C++ Kata - Part 1: Library

Code kata in C++ where you have to write a library of books and magazines.
...
4. Develop your code based at least on C++11.
...
1. Get the code. There are several ways for it:
   ...
   1. With fork (makes it possible to preserve your work):
      1. [Fork this repository](https://github.com/derda17/cpp-kata-1/fork)
   ...
   2. Clone this repository with local branch:
      ```bash
      git clone git@github.com:derda17/cpp-kata-1.git
      git checkout -b run-<yourname>-<iteration number> 
      # Example: git checkout -b run-blaubaer-1
      ```

   3. Just download it from [here](https://github.com/derda17/cpp-kata-1/archive/master.zip)
...
1. By IDE:<br/>
   Follow the instructions of your favorite IDE for cmake based projects
2. By command line:
   ```bash
      cmake -S . -B build
      cmake --build build
